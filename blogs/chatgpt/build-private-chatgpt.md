...
### 4.结束
以上为搭建个人私有ChatGPT的方式，如果需要升级使用GPT4，请看这篇文章[如何升级ChatGPT Plus（GPT4）](https://vaq86.cn/blogs/chatgpt/BuyChatGPTPlus.html)，如果觉得麻烦可免费试用我搭建的这个GPT（https://chat.vaq86.cn），有任何Chat GPT相关的疑问欢迎添加我的微信咨询  
